...
import { ModalService, UploadFilesService, NavigateService, ZoomService, PagePreloadService, RenderPrintService, PasswordService, WindowService } from '@groupdocs.examples.angular/common-components';
...
export class CustomViewerComponent extends ViewerAppComponent {
    ...
    super(_viewerService,_modalService,configService,uploadFilesService,_navigateService,_zoomService,pagePreloadService,_renderPrintService,passwordService,_windowService);
