...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java-Spring/releases/download/1.14.16/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar viewer-spring-1.14.16.jar configuration.yaml
## Open http://localhost:8080/viewer/ in your favorite browser.
```
